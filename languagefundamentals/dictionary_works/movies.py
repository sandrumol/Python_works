...
# Q2- print all movies name

# for movie_name in movies:
#     print(movie_name.get("title"))

movie_names=[name.get("title") for name in movies]
# print(movie_names)


# Q3- print movie name released after 1999

movies_released_after_1999=[movie.get("title") for movie in movies if movie.get("year")>"1999"]
# print(movies_released_after_1999)

# Q4- print number of movies released after 1999

# print(f"The number of movies released after 1999={len(movies_released_after_1999)}")


# Q5- print movie name released before 2000

movies_released_before_2000=[movie.get("title") for movie in movies if movie.get("year")<"2000"]
# print(movies_released_before_2000)

# Q6- print number of movies released before 2000
# print(f"The number of movies released before 2000={len(movies_released_before_2000)}")


# Q7- print "director": "Peter Jackson" movie name

movies_directed_by_Peter_Jackson=[movie.get("title") for movie in movies if movie.get("director")=="Peter Jackson"]
# print(movies_directed_by_Peter_Jackson)


# Q8- print "director": "Christopher Nolan" movie name

movies_directed_by_Christopher_Nolan=[movie.get("title") for movie in movies if movie.get("director")=="Christopher Nolan"]
# print(movies_directed_by_Christopher_Nolan)


# Q9- print actors of movie "Ice Age"

actors_of_Ice_Age=[movie.get("actors") for movie in movies if movie.get("title")=="Ice Age"]
# print(actors_of_Ice_Age)


# Q10- print "actors": "James Stewart" movie name

actor_James_Stewart_movie=[movie.get("title") for movie in movies if "James Stewart" in movie.get("actors")]
# print(actor_James_Stewart_movie)


# Q11- print movie name whose genres contain both drama and comedy


# drama_comedy_movie=[mov.get("title") for mov in movies if "Drama" in mov.get("genres") and "Comedy" in mov.get("genres")]
# print(drama_comedy_movie)

# Q12- print movie name whose genres contain either Sci-Fi or Music

# for mov in movies:
#     if "Sci-Fi" in mov.get("genres") or "Music" in mov.get("genres"):
        # print(mov.get("title"))


# Q13- print most runtime movie

highest_movie_runtime=max(movies,key=lambda mov:int(mov.get("runtime")))
# print(highest_movie_runtime)
# print(highest_movie_runtime.get("title"),highest_movie_runtime.get("runtime"))


# Q14- print movie names having genres <2

genre_gt_2=[mov.get("title") for mov in movies if len(mov.get("genres"))<2]
# print(genre_gt_2)


# Q15- print movie name starts with 's'

# for mov in movies:
#     title_lower=mov.get("title").lower()
#     if title_lower.startswith("s"):
#         print(mov.get("title"))
# OR

title_startswith_s=[mov.get("title") for mov in movies if mov.get("title").startswith("S")]
# print(title_startswith_s)


# Q16- print year wise movies count in dict and max movies released year

year_wise_movie_count={}
for mov in movies:
    year=mov.get("year")
    if year in year_wise_movie_count:
        year_wise_movie_count[year]+=1
    else:
        year_wise_movie_count[year]=1
# print(year_wise_movie_count)
max_year=max(year_wise_movie_count,key=lambda y:year_wise_movie_count.get(y))
# print(f"The maximum movies released year is {max_year}")
max_year_value_key=[(v,k) for k,v in year_wise_movie_count.items()]
# print(max(max_year_value_key))


# Q17- print director wise movies count in dict

director_wise_movie_count={}
for mov in movies:
    director=mov.get("director")
    if director in director_wise_movie_count:
        director_wise_movie_count[director]+=1
    else:
        director_wise_movie_count[director]=1
# print(director_wise_movie_count)
max_director=max(director_wise_movie_count,key=lambda d:director_wise_movie_count.get(d))
# print(f"The director that has more movies is {max_director}")
max_director_value_key=[(v,k) for k,v in director_wise_movie_count.items()]
# print(max(max_director_value_key))


# Q18- print genres wise movies count in dict

genre_wise_movie_count={}
for mov in movies:
    genre=mov.get("genres")
    for g in genre:
        if g in genre_wise_movie_count:
            genre_wise_movie_count[g]+=1
        else:
            genre_wise_movie_count[g]=1
print(genre_wise_movie_count)
max_genre=max(genre_wise_movie_count,key=lambda g:genre_wise_movie_count.get(g))
print(f"The genre that most of the movies have is {max_genre}")
max_genre_value_key=[(v,k) for k,v in genre_wise_movie_count.items()]
print(max(max_genre_value_key))


# Q19- print "Music" genre movie name and plot

# for mov in movies:
#     if "Music" in mov.get("genres"):
#         print("The plot of movie",mov.get("title"),"=",mov.get("plot"))


# Q20- print "War" genre movie name and plot

# for mov in movies:
#     if "War" in mov.get("genres"):
#         print("The plot of movie",mov.get("title"),"=",mov.get("plot"))


# Q21- runtime >150

runtime_gt_150=[mov.get("title") for mov in movies if int(mov.get("runtime"))>150]
# print(runtime_gt_150)


# Q22- print movie name by id

# movie_id=int(input("Enter the id:"))
# for m in movies:
#     if movie_id==m.get("id"):
#         print(m.get("title"))
